...
const SpinWheel = ({ names, setNames }) => {
    ...
    useEffect(() => {
        ...
        names.forEach((name, index) => {
            ...
            slice.setAttribute(
                'd',
                `M50,50 L${x},${y} A${radius},${radius} 0 0,1 ${50 + radius * Math.sin(angle + sliceAngle)
        ...
        <div>
            ...
            <div className="flex justify-center w-full mt-10">
                <button
                    ...
                    className={`py-[4px] border-2 border-btngreen bg-btngreen text-white mt-2 px-10 rounded-2xl text-xl ${isSpinning || names.length < 2
